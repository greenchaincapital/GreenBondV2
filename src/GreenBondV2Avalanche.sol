...
/// @title GreenBondV2
/// @notice ERC4626 Vault on Avalanche, wth USDT as asset and Aave as passive income lockup.
...
contract GreenBondV2 is ERC4626 {
    ...
    /// @notice USDT on avalanche
    ERC20 internal constant ASSET = ERC20(0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7);
    /// @notice aUSDT on avalanche
    ERC20 public constant AAVE_ASSET = ERC20(0x6ab707Aca953eDAeFBc4fD23bA73294241490620);
    /// @notice Aave pool on avalanche (proxy)
